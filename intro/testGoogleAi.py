...
#for k, v in d.items():
    # Verificar si el valor es una instancia de FamilyElement
#   if isinstance(v, FamilyElement):
#       # Obtener los valores de los elementos hijos
#      child_values = [x.get_value() for x in v.get_child_elements()]
        # Imprimir el identificador y los valores de los elementos hijos
#      print(f"Family ID: {k}")
#      print("Child Elements Values:", child_values)
